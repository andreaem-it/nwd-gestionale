...
class ExpertationsAdvancedType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('father', HiddenType::class)
            ...
            ->add('opt11Enabled', CheckBoxType::class, [ 'label' => 'UNDICESIMA AGGIUNTA POSSIBILE: oneri di predisposizione per motorizzazione di tapparelle, persiane, zanzariere, tende e/o oscuranti' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt11_1Value', IntegerType::class, [ 'label' => 'PUNTO PRESA DI SERVIZIO in  traccia sono escluse le opere murarie', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt11_2Value', IntegerType::class, [ 'label' => 'Incremento alla canalizzazione per p.to presa di servizio per opere murarie su murature NON Intonacate. Sono esclusi: l’intonaco, la rasatura e la tinteggiatura', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt11_3Value', IntegerType::class, [ 'label' => 'Canalizzazione per P.to Presa in traccia per distanza non superiori a 60 mt. Sono esclusi i conduttori e le opere murarie.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt11_4Value', IntegerType::class, [ 'label' => 'Incremento alla canalizzazione per p.to presa per opere murarie su murature NON Intonacate. Sono esclusi: l’intonaco, la rasatura e la tinteggiatura', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt11_5Value', IntegerType::class, [ 'label' => 'Maggiorazione per opere murarie su muratura in mattone pieno, calcestruzzo o pietra.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt12Enabled', CheckBoxType::class, [ 'label' => 'DODICESIMA AGGIUNTA POSSIBILE: oneri per passaggio cavi e collegamento di motorizzazioni per tapparelle, persiane, zanzariere, tende e/o oscuranti.				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt12_1Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per impianto di comando di motori monofasi o in c.c. di piccola potenza (serrande meccanizzate etc.). Con pulsante doppio senza chiave.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt12_2Value', IntegerType::class, [ 'label' => 'COMPENSO AGGIUNTIVO AL PUNTO ALLACCIO ELETTRICO PER COLLEGAMENTO AD APPARECCHIATURA DI CONTROLLO E/O COMANDO. Per collegamento motore tenda', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt12_3Value', IntegerType::class, [ 'label' => 'PUNTO ALLACCIO PER PRESA MONOFASE O TRIFASE SU CANALIZZAZIONE IN TRACCIA O SU TUBAZIONE IN VISTA CON CAVO NON PROPAGANTE L\'INCENDIO. Per allaccio monofase con carico max 16A', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt13Enabled', CheckBoxType::class, [ 'label' => 'TREDICESIMA AGGIUNTA POSSIBILE: centralino telefonico con 2 linee esterne e 8 linee interne.				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt13_1Value', IntegerType::class, [ 'label' => 'Centralino tipo appartamento incassato a parete 24  moduli.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt13_2Value', IntegerType::class, [ 'label' => 'Centralino telefonico 2 linee esterno e 8 interni Chiamata alternata Trasferta senza consenso Trasferta Trasferimento di chiamata su linea esterna Trasferta su inclusione Devizione a tempo Trasferta automatica con consenso CLI - Identificativo chiamante.  Conferenza urbana Conferenza locale Modo programmazione giorno/notte Non disturbare Seguimi Chiamate interne generali a gruppi Rubrica Parcheggio linea esterna Risposta per assente su chiamate esterne Room monitor da linea urbana.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt13_3Value', IntegerType::class, [ 'label' => 'Linea telefonica in cavo multicoppie a 2 coppie al metro per linea dorsale', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt13_4Value', IntegerType::class, [ 'label' => 'Trasporto e imballo', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt14Enabled', CheckBoxType::class, [ 'label' => 'QUATTORDICESIMA AGGIUNTA POSSIBILE: impianto citofonico (solo audio)				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt14_1Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per impianto citofonico o videocitofonico, sistema a 2 fili. Per impianto base fino a 26 interni. ', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt14_2Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per impianto citofonico  per ogni posto audio interno', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt14_3Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per audio interno intercomunicante.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt14_4Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per ogni posto esterno audio (PORTER) fino a 2 chiamate.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt14_5Value', IntegerType::class, [ 'label' => 'LINEA IN CAVO LONWORKS PER CONNESSIONI DI RETE TIPO AWG22.  Linea in cavo LonWorks per connessioni di rete tipo AWG22 a due conduttori (una coppia: 2x0,60mm)Twistato e non schermato, con isolamento 1 kV', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt14_6Value', IntegerType::class, [ 'label' => 'Trasporto e imballo', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15Enabled', CheckBoxType::class, [ 'label' => 'QUINDICESIMA AGGIUNTA POSSIBILE: impianto videocitofonico a colori in esecuzione a muro				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt15_1Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per impianto citofonico o videocitofonico, sistema a 2 fili. Per impianto base fino a 26 interni. ', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15_2Value', IntegerType::class, [ 'label' => 'Per ogni posto interno con monitor a colori.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15_3Value', IntegerType::class, [ 'label' => 'Incremento al punto presa di servizio per audio interno intercomunicante.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15_4Value', IntegerType::class, [ 'label' => 'Per ogni posto esterno video fino a due chiamate.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15_5Value', IntegerType::class, [ 'label' => 'Incremento per derivatore di piano audio/video fino a 4 derivati.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15_6Value', IntegerType::class, [ 'label' => 'LINEA IN CAVO LONWORKS PER CONNESSIONI DI RETE TIPO AWG22.  Linea in cavo LonWorks per connessioni di rete tipo AWG22 a due conduttori (una coppia: 2x0,60mm)Twistato e non schermato, con isolamento 1 kV', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt15_7Value', IntegerType::class, [ 'label' => 'Trasporto e imballo', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt16Enabled', CheckBoxType::class, [ 'label' => 'SEDICESIMA AGGIUNTA POSSIBILE: predisposizioni per rilevatori  luminosità.				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt16_1Value', IntegerType::class, [ 'label' => 'PUNTO PRESA DI SERVIZIO in  traccia sono escluse le opere murarie', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt16_2Value', IntegerType::class, [ 'label' => 'Incremento alla canalizzazione per p.to presa di servizio per opere murarie su murature NON Intonacate. Sono esclusi: l’intonaco, la rasatura e la tinteggiatura', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt16_3Value', IntegerType::class, [ 'label' => 'Maggiorazione per opere murarie su muratura in mattone pieno, calcestruzzo o pietra.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt17Enabled', CheckBoxType::class, [ 'label' => 'DICIASSETTESIMA AGGIUNTA POSSIBILE: esempio di soluzione per la  predisposizione di  illuminazione esterna con 20 punti luce.' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt17_1Value', IntegerType::class, [ 'label' => 'Tubazione flessibile in polietilene a doppia parete. Diametro esterno 110 mm ', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt17_2Value', IntegerType::class, [ 'label' => 'Pozzetto in resina completo di coperchio carrabile 300 x 300 mm.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt17_3Value', IntegerType::class, [ 'label' => 'Canalizzazione per P.to luce in traccia per distanza non superiori a 60 mt. Sono esclusi i conduttori e le opere murarie.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt17_4Value', IntegerType::class, [ 'label' => 'Punto luce semplice con o senza conduttore di protezione posato in vista con cavo multipolare derivato da linea dorsale da canale o passerella. Per Punto luce con conduttore di protezione con cavo  idoneo alla posa per luoghi a livello di rischio basso a sigla FG16OR16.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt17_5Value', IntegerType::class, [ 'label' => 'Linea elettrica in cavo multipolare isolato. FG7OR. 3x2,5', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt17_6Value', IntegerType::class, [ 'label' => 'Giunto di derivazione realizzato con muffola in gomma in unico pezzo max 4x25 e derivato 2x1,5mmq. FG7OR', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt18Enabled', CheckBoxType::class, [ 'label' => 'DICIOTTESIMA AGGIUNTA POSSIBILE: predisposizione per impianto fotovoltaico				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt18_1Value', IntegerType::class, [ 'label' => 'Tubazione flessibile in PVC autoestinguente serie pesante IMQ. Diametro esterno mm 32. Al metro.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt19Enabled', CheckBoxType::class, [ 'label' => 'DICIANNOVESIMA AGGIUNTA POSSIBILE: punti presa di servizio per le sonde di temperatura di ogni ambiente, tranne le due conteggiate nella proposta C.				' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt19_1Value', IntegerType::class, [ 'label' => 'Collegamento elettrico di regolazione di impianti tecnologici, eseguito sottotraccia per alimentare dal quadro elettrico di centrale o di zona una apparecchiatura di regololazione (termostato, umidostato, flussostato, sonda di temperatura, pressostato, ecc.)', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt19_2Value', IntegerType::class, [ 'label' => 'Maggiorazione per opere murarie su muratura in mattone pieno, calcestruzzo o pietra.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt20Enabled', CheckBoxType::class, [ 'label' => 'VENTESIMA AGGIUNTA POSSIBILE: cronotermostati ' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt20_1Value', IntegerType::class, [ 'label' => 'Cronotermostato Ambiente.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21Enabled', CheckBoxType::class, [ 'label' => 'VENTUNESIMA AGGIUNTA POSSIBILE: armadio rack' , 'attr' => ['class' => 'custom-control-input'] , 'label_attr' => ['class' => 'custom-control-label'] ])
            ->add('opt21_1Value', IntegerType::class, [ 'label' => 'Armadio rack modulare da 19” per impianti di cablaggio strutturato o consolle, realizzato in acciaio verniciato, completo di porta trasparente provvista di serratura, aperture di areazione superiori ed inferiori. Fornito e posto in opera completo di onere necessario per dare l’opera finita, ed a perfetta regola d’arte. Fino a 24 unità con profondità 600mm in esecuzione da terra completo di zoccolo.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_2Value', IntegerType::class, [ 'label' => 'Kit Ruote per armadi a pavimento. Fornito e posto in opera', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_3Value', IntegerType::class, [ 'label' => 'Pannello di alimentazione con min. 5 prese UNEL 16A+T, interruttore bipolare e spia di presenza rete.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_4Value', IntegerType::class, [ 'label' => 'PATCH PANEL PER ARMADI DI CABLAGGIO STRUTTURATO.  Patch panel per armadi di cablaggio strutturato, completo di connettori RJ45 UTP o S-FTP a 8 pin con connessione ad incisione di isolante tipo 110, su morsettiera centrale per cavo 22-26AWG, o mediante connettori singoli, completo di barra guidacavi, esclusa la quota per attestazione delle linee in ingresso ed uscita. Fornito e posto in opera a perfetta regola d’arte.  Fino a 16 porte non schermato con connettori RJ45 per cavo UTP cat. 6.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_5Value', IntegerType::class, [ 'label' => 'PATCH PANEL PER ARMADI DI CABLAGGIO STRUTTURATO.  Patch panel per armadi di cablaggio strutturato, completo di connettori RJ45 UTP o S-FTP a 8 pin con connessione ad incisione di isolante tipo 110, su morsettiera centrale per cavo 22-26AWG, o mediante connettori singoli, completo di barra guidacavi, esclusa la quota per attestazione delle linee in ingresso ed uscita. Fornito e posto in opera a perfetta regola d’arte. Fino a 24 porte non schermato con connettori RJ45 per cavo UTP cat. 6.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_6Value', IntegerType::class, [ 'label' => 'Pannello Passa Cavi. Fornito e posto in opera', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_7Value', IntegerType::class, [ 'label' => 'Patch cord tipo UTP cat. 6  fino a 1 m.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_8Value', IntegerType::class, [ 'label' => 'Patch cord tipo UTP cat. 6  fino a 3 m.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_9Value', IntegerType::class, [ 'label' => 'Incremento alla singola porta per attestazione conduttori e certificazione.', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_10Value', IntegerType::class, [ 'label' => 'Mensola di supporto portata max. 50Kg. Profondità 600 mm', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_11Value', IntegerType::class, [ 'label' => 'Mensola di supporto portata max. 15Kg. Profondità 400 mm', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_12Value', IntegerType::class, [ 'label' => 'Pannello cieco 1 unità', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_13Value', IntegerType::class, [ 'label' => 'Pannello cieco 2 unità', 'attr' => ['class' => 'custom-form-control'] ])
            ->add('opt21_14Value', IntegerType::class, [ 'label' => 'Gruppo di ventilazione per circolazione forzata di aria ad una ventola', 'attr' => ['class' => 'custom-form-control'] ])
        ;
    }/**
     * {@inheritdoc}
     */
