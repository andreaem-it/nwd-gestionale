 ...
 */
class Announcements extends \AppBundle\Entity\Announcements implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Announcements' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Announcements' . "\0" . 'datetime', '' . "\0" . 'AppBundle\\Entity\\Announcements' . "\0" . 'creator', '' . "\0" . 'AppBundle\\Entity\\Announcements' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Announcements' . "\0" . 'expiration'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Announcements $proxy) {
