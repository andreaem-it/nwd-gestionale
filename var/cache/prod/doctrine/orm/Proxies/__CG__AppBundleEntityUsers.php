...
class Users extends \AppBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'lastAccess', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'role'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUserame($name)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserame', [$name]);

        return parent::setUserame($name);
    }
