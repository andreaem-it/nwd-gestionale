...
class Users extends \AppBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'groups', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'father', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'picture', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'roles'];
        }
