...
$c->setOptions(array('login_path' => 'login', 'default_target_path' => 'dashboard', 'always_use_default_target_path' => true, 'use_referer' => true, 'target_path_parameter' => '_target_path'));
