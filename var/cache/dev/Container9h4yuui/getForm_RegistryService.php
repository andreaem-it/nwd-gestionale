...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ExpertationsAdvancedType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ExpertationsAdvancedType']) ? $this->services['AppBundle\Form\ExpertationsAdvancedType'] : $this->services['AppBundle\Form\ExpertationsAdvancedType'] = new \AppBundle\Form\ExpertationsAdvancedType()) && false ?: '_'};
    ...
    return ${($_ = isset($this->services['fos_user.group.form.type']) ? $this->services['fos_user.group.form.type'] : $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('AppBundle\\Entity\\Groups')) && false ?: '_'};
