    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "
                                        ...
                                        <th
                                            ";
        // line 32
        if (twig_get_attribute($this->env, $this->source, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new Twig_Error_Runtime('Variable "pagination" does not exist.', 32, $this->source); })()), "isSorted", array(0 => "a.Name"), "method")) {
            echo " class=\"sorted\"";
        }
        echo ">";
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->sortable($this->env, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new Twig_Error_Runtime('Variable "pagination" does not exist.', 32, $this->source); })()), "Cliente", "a.name");
        echo "
                                        </th>
                                        <th
                                            ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            echo "\" class=\"btn btn-warning btn-sm float-right\">
...
";
    ...
    {
        return array (  231 => 88,  226 => 85,  213 => 78,  207 => 75,  201 => 72,  192 => 68,  184 => 65,  172 => 62,  166 => 59,  160 => 56,  154 => 53,  150 => 51,  146 => 50,  124 => 35,  114 => 32,  108 => 29,  97 => 20,  91 => 19,  82 => 16,  77 => 15,  72 => 14,  68 => 13,  62 => 10,  53 => 3,  44 => 2,  15 => 1,);
    }
                            ...
                            <div class=\"table-responsive\">
                                <table class=\"table table-hover\">
                                    ...
                                    <tr>
                                        ...
                                        <th
                                            {% if pagination.isSorted('a.Name') %} class=\"sorted\"{% endif %}>{{ knp_pagination_sortable(pagination, 'Cliente', 'a.name') }}
                                        </th>
                                        <th
                                    ...
                                    {% for item in pagination %}
                                        <tr>
                                            ...
                                            <td style=\"width: 255px;\">
                                                <div class=\"btn-group\">
                                                    <a href=\"{{ url('vedi_clienti',{'id' : 1}) }}\" class=\"btn btn-primary btn-sm float-right\">
                                                        <span class=\"mdi mdi-eye-outline\"></span>
                                                    </a>
                                                    <a href=\"{{ url('modifica_cliente' , { 'id' : item.id }) }}\" class=\"btn btn-warning btn-sm float-right\">
                                                        <span class=\"mdi mdi-table-edit\"></span>
                                                    </a>
                                                    <a href=\"{{ url('elimina_clienti', { 'id' : item.id }) }}\" class=\"btn btn-danger btn-sm float-right\">
                                                        <span class=\"mdi mdi-delete\"></span>
                                                    </a>
                                                </div>
                                            </td>
