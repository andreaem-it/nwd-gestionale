...
class __TwigTemplate_dc1eaa33b2f8da771982860668153274f9febd134591ec186efc1f676826beb5 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "; i++) {
                                ...
                                calcLineTotal(";
        // line 2834
        echo twig_escape_filter($this->env, (isset($context["colCount"]) || array_key_exists("colCount", $context) ? $context["colCount"] : (function () { throw new Twig_Error_Runtime('Variable "colCount" does not exist.', 2834, $this->source); })()), "html", null, true);
        echo ", valn );
                            }
                ...
                function calculate(field) {
                    for(var i = 0; i < ";
        // line 2841
        echo twig_escape_filter($this->env, (isset($context["colCount"]) || array_key_exists("colCount", $context) ? $context["colCount"] : (function () { throw new Twig_Error_Runtime('Variable "colCount" does not exist.', 2841, $this->source); })()), "html", null, true);
        echo "; i++) {
                        var ind = i +1;
                ...
                function checkedAddon(id) {
                    if(\$('.btn-addon-' + id).hasClass('btn-success').removeClass('collapse')) {
                ...
                function addonClick(i) {
                    //\$('#appbundle_expertationsadvanced_opt' + i + 'Enabled').click( function () {
                        \$('.btn-addon-' + i).switchClass('btn-primary', 'btn-success').switchClass('collapsed', '');
                    //});
                }
                function calcLineTotal(c,v) {
                    ...
                    var c = (parseInt(c) + 1);
                    for (i=1; i < c; i++) {
                        vals.push(\$('#form_' + v + '_' + i).val());
                    }
                    console.log(vals);
                    for(var i = 0, len = vals.length; i < len; i++) {
                        myTotal += parseInt(vals[i]);
                    }
                    console.log(v + ':' + myTotal);
                    \$('#form_' + v + '_total').html('<strong>' + myTotal + '</strong>');
                }
                /*\$(document).ready( function() {
                    for (i = 1; i < 64; i++) {
                        calcLineTotal( 1 ,  i)
