    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/pr')) {
            if (0 === strpos($pathinfo, '/preventivi')) {
                ...
                if (0 === strpos($pathinfo, '/preventivi/dettaglio')) {
                    // preventivi_dettaglio_id
                    if (preg_match('#^/preventivi/dettaglio/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/preventivi/dettaglio/avanzato/preventivo-') && preg_match('#^/preventivi/dettaglio/avanzato/preventivo\\-(?P<pid>[^/]++)$#sD', $pathinfo, $matches)) {
        ...
        elseif (0 === strpos($pathinfo, '/testchart')) {
            // chart_bar
            if ('/testchart/bar' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::barAction',  '_route' => 'chart_bar',);
            }

            // chart_horizontalBar
            if ('/testchart/horizontalBar' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::horizontalBarAction',  '_route' => 'chart_horizontalBar',);
            }

            // chart_pie
            if ('/testchart/pie' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::pieAction',  '_route' => 'chart_pie',);
            }

            // chart_polarArea
            if ('/testchart/polarArea' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::polarAreaAction',  '_route' => 'chart_polarArea',);
            }

            // chart_doughnut
            if ('/testchart/doughnut' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::doughnutAction',  '_route' => 'chart_doughnut',);
            }

            // chart_line
            if ('/testchart/line' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::lineAction',  '_route' => 'chart_line',);
            }

            // chart_radar
            if ('/testchart/radar' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::radarAction',  '_route' => 'chart_radar',);
            }

            // chart_stackedbar
            if ('/testchart/stackedBar' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::stackedBarAction',  '_route' => 'chart_stackedbar',);
            }

            // chart_main_test
            if ('/testchart/mainTest' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::mainTestAction',  '_route' => 'chart_main_test',);
            }

            // chart_combotest
            if ('/testchart/comboTest' === $pathinfo) {
                return array (  '_controller' => 'fados\\ChartjsBundle\\Controller\\ChartjsController::comboTestAction',  '_route' => 'chart_combotest',);
            }
