...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'app.chartjs.transformer_char' => 'getApp_Chartjs_TransformerCharService.php',
        ...
        $this->privates = array(
            ...
            'app.chartjs.transformer_char' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/fados/chartjs-bundle/Twig/chartjsExtension.php';
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \fados\ChartjsBundle\Twig\chartjsExtension($this));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/views'), '!KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'/vendor/fados/chartjs-bundle/Resources/views'), 'Chartjs');
        $instance->addPath(($this->targetDirs[3].'/vendor/fados/chartjs-bundle/Resources/views'), '!Chartjs');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ChartjsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/fados/chartjs-bundle'),
                    'namespace' => 'fados\\ChartjsBundle',
                ),
                'AppBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ChartjsBundle' => 'fados\\ChartjsBundle\\ChartjsBundle',
            ...
            'database_host' => '192.168.1.187',
            'database_name' => 'gestionale',
            'database_user' => 'root',
            'database_password' => 'Odessa.201X',
            ...
            'chartjs.animation' => array(
                'duration' => 1000,
                'easing' => 'easeOutQuart',
            ),
            'chartjs.layout' => array(
                'padding' => 0,
            ),
            'chartjs.legend' => array(
                'display' => true,
                'position' => 'top',
                'fullWidth' => true,
                'reverse' => false,
